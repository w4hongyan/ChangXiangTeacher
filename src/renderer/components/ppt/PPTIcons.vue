<template>
  <div class="ppt-icon" :style="iconStyles">
    <svg 
      :width="size" 
      :height="size" 
      :viewBox="viewBox" 
...
// 图标库 - 常用商务和教育图标
const iconLibrary: Record<string, { path: string; viewBox?: string }> = {
  // 商务类图标
  'business': {
  ...
  'team': {
    path: 'M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zm4 18v-6h2.5l-2.54-7.63A2.996 2.996 0 0 0 17.06 7H16.94c-1.05 0-2.02.54-2.58 1.42L12 12l2.36 3.58c.56.88 1.53 1.42 2.58 1.42H18v5h2zM12.5 11.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5S11 9.17 11 10s.67 1.5 1.5 1.5zM5.5 6c1.11 0 2-.89 2-2s-.89-2-2-2-2 .89-2 2 .89 2 2 2zm2 16v-7H9V9.5c0-.8-.69-1.5-1.5-1.5S6 8.7 6 9.5V15H4v7h3.5z'
  },
  'innovation': {
  ...
  'certificate': {
    path: 'M14 9V5h3V3H7v2h3v4c-3.94.49-7 3.85-7 8h2c0-3.31 2.69-6 6-6s6 2.69 6 6h2c0-4.15-3.06-7.51-7-8z'
  },
  
  // 科技类图标
  'technology': {
    path: 'M20 3H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h3l-1 1v2h12v-2l-1-1h3c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 13H4V5h16v11z'
  },
  'code': {
...
const iconPath = computed(() => {
  const icon = iconLibrary[props.name]
  return icon ? icon.path : iconLibrary['lightbulb'].path // 默认图标
})
...
const iconStyles = computed(() => {
  ...
  if (props.theme) {
    styles.color = props.color === 'currentColor' ? props.theme.colors.primary : props.color
  }
